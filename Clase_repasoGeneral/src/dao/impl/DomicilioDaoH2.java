...
public class DomicilioDaoH2 implements IDao<Domicilio> {
    ...
    private static final String INSERT = "INSERT INTO domicilios VALUES(?, ?, ?, ?, ?);";
    ...
    public Domicilio guardar(Domicilio domicilio) {
        ...
        try{
            ...
            if(domicilio.getId() == null){//si el domicilio es nuevo, osea viene sin un id la db lo define
                pStmn.setNull(1, Types.INTEGER); //activa el default pasandole null
            }else{
